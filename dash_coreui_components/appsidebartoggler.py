...
- type (string; optional): The HTML type, defauls to `button`."""
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, display=Component.UNDEFINED, mobile=Component.UNDEFINED, tag=Component.UNDEFINED, type=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'className', 'display', 'mobile', 'tag', 'type']
        self._type = 'appsidebartoggler'
        self._namespace = 'dash_coreui_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'className', 'display', 'mobile', 'tag', 'type']
