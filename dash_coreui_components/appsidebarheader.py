...
class appsidebarheader(Component):
    """A appsidebarheader component.
CoreUI sidebar header component.

Keyword arguments:
- children (a list of or a singular dash component, string or number; optional): The children.
- id (string; optional): The ID used to identify this component in Dash callbacks, defaults to `appsidebarheader`.
        ...
        if(any(getattr(self, c, None) is not None
           ...
           or any(getattr(self, c, None) is not None
            ...
            wilds_string = ', '.join([c+'='+repr(getattr(self, c, None))
                                      ...
                                      for wc_attr in
                                      self._valid_wildcard_attributes])])
            return ('appsidebarheader(' + props_string +
