...
class appfooter(Component):
    """A appfooter component.
CoreUI footer component.

Keyword arguments:
- children (a list of or a singular dash component, string or number; optional): The children.
- id (string; optional): The ID used to identify this component in Dash callbacks, defaults to `appfooter`.
...
- tag (string; optional): The HTML tag, defaults to `footer`.
